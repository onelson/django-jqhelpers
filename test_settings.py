...
STATICFILES_ROOT = projpath('static')
...
SECRET_KEY = 'dv(kkl1&6$+8=i56a^y++%i6t_g!0j!q_@4@&0s1)x33+ex%(4'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'jqhelpers.context_processors.jqhelpers',
)
